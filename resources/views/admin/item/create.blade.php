              ...
              <div class="row form-group">
                ...
                <div class="row form-group">
                  <div class="col-md-6">
                    ...
                    <div class="col-md-9 {{ $errors->first('model', 'has-error') }}">
                        <!-- <input type="text" name="model" id="model" value="{{ old('model') }}" class="form-control unicode" placeholder="Enter Model Name"> -->
                        <div class="frmSearch">
                        <input type="text" id="auto" placeholder="Model" class="form-control" name="model" value="{{old('model')}}" />
                 ...
                 <div class="col-md-6">
                    ...
                    <div class="col-md-9 ">
                        <input type="number" name="price" id="price" value="{{ old('price') }}" class="form-control unicode" placeholder="Enter Price Number">
                    </div> 
                    </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                   ...
                   <label class="col-md-3 unicode">Item Code</label>
                        ...
                        <input type="text" name="item_code" class="form-control unicode" placeholder="Item code">
